...
<button class="close-btn" onclick="window.location.href='/localGuides'">&times;</button>
    <div class="row">
            ...
            <div id="tourImages" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="images/guide9.jpg" class="d-block w-100" alt="Cultural Heritage Walk Image 1">
                    </div>
                    <div class="carousel-item">
                        <img src="images/guide8.jpg" class="d-block w-100" alt="Cultural Heritage Walk Image 2">
                    </div>
                </div>
        ...
        <div class="col-md-6 details-section">
            <h2>Cultural Heritage Walk</h2>
            <p>Explore the rich cultural heritage of the city as you walk through historic neighborhoods with an expert guide. Learn about the history, architecture, and stories behind the city's iconic landmarks.</p>
            <ul class="list-unstyled">
                ...
                <li><strong>Live tour guide:</strong> English, Spanish</li>
            ...
            <p class="total-cost">
                <strong>Total Cost: ₹<span id="totalCost">3999</span> (for <span id="displayCandidates">1</span> candidate)</strong>
            </p>
    ...
    <div class="row mt-4">
        <div class="col-12 details-section">
            ...
            <ul>
                <li>Explore the rich cultural history of the city’s neighborhoods.</li>
                <li>Visit landmarks such as historic buildings, monuments, and squares.</li>
                <li>Learn about the city's history, architecture, and famous events.</li>
                <li>Walk through iconic areas, including old town districts and cultural sites.</li>
            </ul>
            <h3>Includes</h3>
            <ul>
                <li>Professional tour guide</li>
                <li>Walk through historic neighborhoods</li>
                <li>Visit iconic landmarks</li>
            </ul>
            <p><strong>Meeting Point:</strong> In front of the Old Town Gate</p>
...
<script>
    const pricePerPerson = 3999; // Price per person for the cultural walk
